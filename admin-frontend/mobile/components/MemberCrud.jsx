...
const MemberCrud = ({
  ...
  return (
    <View
      className={`${isKeyboardVisible ? "pb-150px] top-[280px]" : "top-1/2"} flex-1 justify-center items-center absolute -translate-x-1/2  -translate-y-1/2 left-1/2`}
    >
      {loading && (
      ...
      <View className=" w-[360px] flex-1 rounded-3xl overflow-hidden">
        ...
        <View className="flex-1 justify-start items-center">
          <View className="bg-black/20 h-14 w-full justify-center items-center relative">
            ...
            <Text className="text-white text-[30px] font-jura">{type}</Text>
          </View>
